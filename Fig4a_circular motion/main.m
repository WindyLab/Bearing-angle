%% Numerical simulation for Fig 4a
% observer: circular motion around the target
...
total_time = 10;         % total simulation time for each Monte Carlo iteration
...
est_init_tar_size = 1.6;        % initial target's size
...
for n = 1:total_N
    % estimated states' covariance (initialization)
