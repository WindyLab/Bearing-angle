...
%OBSERVER, calculate noised bearing and angle measurements
...
theta_real = theta;
%% add Gauss noise
epsilon =  1.163*normrnd(0, sigma_g);  % this makes the final standard deviation of the bearing noise to be around 0.01
